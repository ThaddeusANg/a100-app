...
echo "Email Check: ".$emailCheck;
echo "cohort Check: ".$cohortCheck."</br>";
$sqlDup = 
...
$keyArray=array();
while($dupContent = mysqli_fetch_array($dup)){
		echo "test identity_id:".$dupContent['identity_id'];
	}
			        ...
			        if($_POST[$colName]==NULL){  
			        	...
			        	// writes a NULL value like for PK
			        	{
			        		if($required==1){
			        			...
			        			echo "column content:".$dupContent['identity_id']."</br>";
